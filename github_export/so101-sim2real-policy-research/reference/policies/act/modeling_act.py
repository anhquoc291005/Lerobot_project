...
class ACT(nn.Module):
    ...
    def forward(self, batch: dict[str, Tensor]) -> tuple[Tensor, tuple[Tensor, Tensor] | tuple[None, None]]:
        ...
        # Determine batch_size from available features (try OBS_IMAGES, then OBS_ENV_STATE, then ACTION)
        if OBS_IMAGES in batch and batch[OBS_IMAGES]:
            ...
            raise KeyError(
                f"Cannot determine batch size. None of {OBS_IMAGES}, {OBS_ENV_STATE}, or {ACTION} found in batch."
            )
